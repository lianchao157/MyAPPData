package activity.com.myappdata.activity.tabchange;
...
import activity.com.myappdata.adapter.tabchange.MainFragmentAdapter;
...
public class TabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTabs(tab_layout01, getLayoutInflater(), TAB_TITLES, TAB_IMGS);
    }
    ...
    private void initPager() {
        ...
        // 关联切换
        viewPager.addOnPageChangeListener(new TabLayout.TabLayoutOnPageChangeListener(tab_layout01));
tab_layout01.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
    @Override
