...
import activity.com.myappdata.adapter.fuzaadapter.MainAdapter;

public class ManyRecycleviewTitleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_many_recycleview_title);
        ...
        //添加数据
        addData();
        adapter = new MainAdapter(ManyRecycleviewTitleActivity.this, mDatas);
        recyclerView.setAdapter(adapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(ManyRecycleviewTitleActivity.this));
        //滑动监听
