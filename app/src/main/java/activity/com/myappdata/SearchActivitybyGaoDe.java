...
import activity.com.myappdata.util.traffictransfer.BusResultListAdapter;

public class SearchActivitybyGaoDe  extends AppCompatActivity implements AMap.OnMapClickListener,
    ...
    private LatLonPoint mEndPoint = new LatLonPoint(41.80000, 123.38333);//终点，116.481288,39.995576
    private LatLonPoint mStartPoint_bus = new LatLonPoint(40.818311, 111.670801);//起点，111.670801,40.818311
    private LatLonPoint mEndPoint_bus = new LatLonPoint(41.80000, 123.38333);//终点，
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_activityby_gao_de);
...
//		getIntentData();
    ...
    private void setfromandtoMarker() {
        aMap.addMarker(new MarkerOptions()
                ...
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.bg_but_ensure)));
        aMap.addMarker(new MarkerOptions()
                .position(AMapUtil.convertToLatLng(mEndPoint))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_list_o)));
    }
    ...
    public void searchRouteResult(int routeType, int mode) {
        if (mStartPoint == null) {
            ToastUtil.makeText(mContext, "起点未设置");
            return;
        }
        if (mEndPoint == null) {
            ToastUtil.makeText(mContext, "终点未设置");
        }
        showProgressDialog();
        ...
        if (errorCode == 1000) {
            if (result != null && result.getPaths() != null) {
                if (result.getPaths().size() > 0) {
                    ...
                    ToastUtil.makeText(mContext,"没结果");
                }
            } else {
                ToastUtil.makeText(mContext, "没结果");
            }
        } else {
            ToastUtil.makeText(this.getApplicationContext(), ""+errorCode);
        }
    }
