...
import activity.com.myappdata.AMapRouteActivity;
...
public
class BusRouteOverlay  extends RouteOverlay {
    ...
    public BusRouteOverlay(AMapRouteActivity aMapRouteActivity, AMap aMap, BusPath busPath, LatLonPoint startPos, LatLonPoint targetPos) {
        super(aMapRouteActivity, aMap, busPath, startPos, targetPos);
    }
