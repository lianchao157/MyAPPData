package activity.com.myappdata.util.networkutils.netcallback;
...
import activity.com.myappdata.util.networkutils.core.MethodManager;
import activity.com.myappdata.util.networkutils.core.NetType;
import activity.com.myappdata.util.networkutils.core.*;
...
public class NetworkCallbackImpl extends ConnectivityManager.NetworkCallback {
    ...
    private List<MethodManager> findAnnotationMethods(Object observer) {
        ...
        for (Method method : methods) {
            //获取方法注解
        activity.com.myappdata.util.networkutils.core.Network network = method.getAnnotation(activity.com.myappdata.util.networkutils.core.Network.class);
            if (network == null) {
                continue;
            }
            //方法参数校验
