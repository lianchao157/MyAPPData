...
//            int connectivityStatus = NetStatusMonitor.getConnectivityStatus(context);
...
//        }
//        mType = networkType;
//        if (networkType == NetStatusMonitor.TYPE_MOBILE) {
//            for (NetStateChangeObserver observer : mObservers) {
//                observer.onMobileConnect();
//            }
//        } else if (networkType == NetStatusMonitor.TYPE_WIFI) {
//            for (NetStateChangeObserver observer : mObservers) {
