package activity.com.myappdata.util.writelog;
...
public class LogService extends Service
{
    ...
    public String getLogPath()
    {
        ...
        System.out.println(""+LOG_PATH_SDCARD_DIR + File.separator + logFileName);
...
//————————————————
//    版权声明：本文为CSDN博主「-无-怨-无-悔-」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
//    原文链接：https://blog.csdn.net/chenhande1990chenhan/article/details/54138627
}
