...
import activity.com.myappdata.adapter.ItemRecommendAdapter;
import activity.com.myappdata.adapter.NetworkImageHolderView;
import activity.com.myappdata.bean.RecommendGoodsBean;
import activity.com.myappdata.widget.SlideDetailsLayout;
...
public class GoodsInfoFragment extends Fragment implements View.OnClickListener, SlideDetailsLayout.OnSlideDetailsListener {
    ...
    private void scrollCursor() {
        ...
        for (int i = 0; i < tabTextList.size(); i++) {
            tabTextList.get(i).setTextColor(i == nowIndex ? getResources().getColor(R.color.red_btn_color_normal) : getResources().getColor(R.color.black));
        }
    }
